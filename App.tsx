...
import { Terminal, Cpu, Activity, ShieldCheck, Radio, Lock, SignalHigh, Globe, Key, AlertCircle } from 'lucide-react';
      ...
      <header className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 p-5 flex items-center justify-between z-30">
        <div className="flex items-center space-x-8">
          ...
          <div className="flex space-x-3">
            <StatusBadge icon={Activity} label="System Engine" value={coreState} color={stateColor} />
